...
export const DiscoveryDeskComposition: React.FC<DiscoveryDeskCompositionProps> = ({
  ...
  return (
    <div className="relative w-full max-w-[460px] lg:max-w-[490px] mx-auto select-none pt-2 pb-2 px-2 sm:px-4">
      {/* ========================================================================= */}
      {/* 1. COMPACT ELEGANT CURVED JOURNEY PATH (Explore -> Match -> Scholarship -> Future) */}
      {/* ========================================================================= */}
      <div className="relative w-full mb-1 pointer-events-none">
        {/* Compact SVG Dotted Arc */}
        <svg
        ...
        {/* Node 1: EXPLORE */}
        <div className="absolute left-[8%] top-[24px] flex flex-col items-center -translate-x-1/2">
        ...
        {/* Node 2: MATCH */}
        <div className="absolute left-[38%] top-[4px] flex flex-col items-center -translate-x-1/2">
          <div className="w-6 h-6 rounded-full bg-[#065F46] text-white flex items-center justify-center shadow-xs ring-2 ring-[#FAF8F5] dark:ring-[#0C1513]">
        ...
        {/* Node 3: SCHOLARSHIP */}
        <div className="absolute left-[70%] top-[6px] flex flex-col items-center -translate-x-1/2">
        ...
        {/* Node 4: FUTURE */}
        <div className="absolute right-[4%] top-[8px] flex flex-col items-center translate-x-1/2">
          <div className="w-6 h-6 rounded-full bg-[#065F46] text-white flex items-center justify-center shadow-xs ring-2 ring-[#FAF8F5] dark:ring-[#0C1513]">
      ...
      {/* ========================================================================= */}
      {/* 2. MAIN SCENE: PROPORTIONATE 3D LAPTOP + BOOKS + FLOATING CAP + CARD      */}
      {/* ========================================================================= */}
      <div className="relative pt-1">
        {/* Supporting Left: Stack of 3 Books & Plant (Scaled down, non-competing) */}
        <div className="absolute -left-3 sm:-left-6 bottom-4 sm:bottom-6 z-20 pointer-events-none">
          {/* Subtle Foliage behind books */}
          ...
          <div className="relative z-10 filter drop-shadow-md">
            <svg width="78" height="56" viewBox="0 0 105 74" fill="none">
              <ellipse cx="52" cy="70" rx="46" ry="4" fill="#064E3B" fillOpacity="0.18" />
              {/* Book 1 (Bottom) */}
        ...
        {/* 3D LAPTOP (15-20% smaller, fully visible without cropping) */}
        <div
          ...
          >
            ...
            <div className="rounded-t-xl bg-gradient-to-b from-[#1E293B] to-[#0F172A] p-2 pt-1.5 pb-1 shadow-xl border border-slate-700/80">
              ...
              <div className="flex items-center justify-center pb-0.5">
                <span className="w-1.2 h-1.2 rounded-full bg-slate-500 inline-block" />
              </div>
                ...
                <div className="grid grid-cols-12 gap-2 text-left items-center">
                  ...
                  <div className="col-span-8 space-y-1">
                    <div>
                      ...
                      <p className="text-[7px] text-stone-500 dark:text-stone-400">
                        Personalized matches for your studies
                      </p>
                    </div>
                    ...
                    <button
                      ...
                      className="w-full mt-0.5 py-1 px-2 rounded bg-[#064E3B] hover:bg-[#043E2F] text-white text-[8.5px] font-bold shadow-xs flex items-center justify-center gap-1 transition-colors cursor-pointer"
                    >
                  ...
                  <div className="col-span-4 h-full flex items-center">
                    <div className="w-full py-2.5 px-1 rounded-lg bg-[#F0FDF4] dark:bg-[#142420] border border-emerald-200/80 dark:border-emerald-800/80 text-center flex flex-col items-center justify-center">
            ...
            <div className="relative">
              ...
              <div className="h-4 w-[90%] mx-auto bg-slate-900/18 dark:bg-black/50 blur-lg rounded-full -mt-2" />
            </div>
          </div>
        </div>

        {/* Floating Graduation Cap (Above/Behind Upper-Right of Laptop, NOT glued to corner) */}
        <div
        ...
        {/* Gold Sparkle ✦ */}
        <div className="absolute right-12 sm:right-16 top-4 z-20 pointer-events-none">
        ...
        {/* ONE FLOATING SCHOLARSHIP CARD (Moved UPWARD & RIGHT, fully visible within viewport) */}
        <div
